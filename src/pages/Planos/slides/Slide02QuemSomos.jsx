const Slide02QuemSomos = () => (
  <div className="slide-base dark" style={{ textAlign: 'center' }}>
    <div className="slide-inner">
      <div className="slide-label">A equipe</div>
      <h1 className="slide-h1" style={{ color: '#fff' }}>
        Quem está por trás<br />
        <span className="slide-brand">dos resultados?</span>
      </h1>
      <p className="slide-body" style={{ maxWidth: 520, margin: '0 auto' }}>
